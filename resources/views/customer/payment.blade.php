        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default">
                    {{-- <img src="customer/img/bg-img/crafttaryshop.jpg" width="550px" length="100px" alt=""> --}}
                </div>
                <div class="panel panel-default">
                    <img src="customer/img/bg-img/16.png" alt="">
                    <div class="panel-body">
                        ...
                        <form role="form" action="{{ route('make-payment') }}" method="post" class="stripe-payment"
                            ...
                            <div class='form-row row'>
                                <ul>
                                    <li><h4>Subtotal : ${{$total}}.00 </h4>
                                    </li>
                                    <li><h4>Delivery Charge : ${{$delivery_charge}}.00</h4>
                                    </li>
                                    <li><h4>Total : ${{$total+$delivery_charge}}.00</h4>
                                    </li>
                                </ul>
