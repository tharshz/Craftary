                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="{{asset('admin/images/icon/images.jfif')}}" alt="Sureshkumar" />
                                        </div>
                                        
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Sureshkumar</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">Sureshkumar</a>
                                                    </h5>
                                                    <span class="email">crafttarylaser@gmail.com</span>
                                                </div>
                                            </div>
